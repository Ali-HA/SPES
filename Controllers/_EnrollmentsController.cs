...
namespace ACMWeb.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult EnrollemntUp() {
            if (TempData["fileName"] != null)
            {
                ...
                foreach (var rec in records) {
                    ...
                    var enrol = new Enrollment() { EnrollmentDate = DateTime.Now, SectionID = rec.SectionID, Student_ID = rec.StudentID, Status = rec.Status };
        ...
        public ActionResult Index()
        {
            ...
            enrollments = enrollments.OrderBy(a => a.Student_ID).ThenBy(a => a.SectionID);
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,SectionID,StudentID,LetterGradeID,EnrollmentDate,Status")] Enrollment enrollment)
        {
